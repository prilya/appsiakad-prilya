...
public class FrMenu extends javax.swing.JFrame {
    ...
    private void aksiLogin(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Error method akksiLogin() : "+ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbKeterangan, javax.swing.GroupLayout.DEFAULT_SIZE, 22, Short.MAX_VALUE)
        );

        jpMenu.setBackground(java.awt.Color.blue);
        ...
        jLabel3.setText("-{ Sistem Informasi Akademik Akuntansi Keuangan }-");
        ...
        panelLogin.addTab("Login User", new javax.swing.ImageIcon(getClass().getResource("/Image/Admin-Schoolar-Icon.png")), jPanel3); // NOI18N
        ...
        jLabel6.setText("Sekolah Tinggi Akuntansi Keuangan (STAK)");
    ...
    public static void main(String[] args) throws UnsupportedLookAndFeelException, 
        ...
        try{
            com.jtattoo.plaf.mcwin.McWinLookAndFeel.setTheme("Default", "Jawa Swing", "");
